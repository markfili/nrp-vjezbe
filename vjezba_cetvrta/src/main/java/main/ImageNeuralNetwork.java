...
import utilities.ImageEditingClass;
...
public class ImageNeuralNetwork {
    ...
    private static final String CHESS_INITIAL_IMAGE_NAME = "chess_board_clean.jpg";
    private static final String CHESS_MIXED_IMAGE_NAME = "chess_board_mixed.jpg";
    private static final String CHESS_BOARD_INITIAL_FOLDER = "polja/";
    private static final String CHESS_BOARD_MIXED_FOLDER = "polja_mixed/";
...
//        checkIfImagesExist(CHESS_BOARD_INITIAL_FOLDER, CHESS_INITIAL_IMAGE_NAME);
    ...
    private void cutMixedImage() {
        checkIfImagesExist(CHESS_BOARD_MIXED_FOLDER, CHESS_MIXED_IMAGE_NAME);
    }
    ...
    private void whatIs() {
        ...
        do {
            try {
                System.out.print("Na polju oznake >> ");
                polje = unos.nextLine();
                String filename = "./" + CHESS_BOARD_MIXED_FOLDER + polje.toUpperCase() + ".jpg";
                ...
                if (ex instanceof IIOException) {
                    System.out.println("Polje nije nadjeno, pokusajte ponovno");
                    polje = "repeat";
                }
            }
    ...
    private static void checkIfImagesExist(String folderPath, String imageName) {
        File imagesFolder = new File(folderPath);

        if (imagesFolder.exists() || imagesFolder.mkdir()) {
            try {
                ImageEditingClass.kreirajSlike(folderPath, imageName);
            } catch (IOException e) {
                e.printStackTrace();
            }
        }
